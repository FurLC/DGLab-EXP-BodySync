...
namespace DGLab.BepInEx
{
    internal sealed class DGLabWaveMonitorWindow
    {
        ...
        private WavePreviewEntry[] WaveLibraryEntries()
        {
            return new[]
            {
                new WavePreviewEntry(_owner.T("Hit damage", "受伤冲击"), DGLabWaveLibrary.DamagePulse),
                new WavePreviewEntry(_owner.T("Blunt impact", "钝器冲击"), DGLabWaveLibrary.ImpactPulse),
                new WavePreviewEntry(_owner.T("Bone break event", "骨折瞬间"), DGLabWaveLibrary.BreakPulse),
                new WavePreviewEntry(_owner.T("Dislocation event", "脱臼瞬间"), DGLabWaveLibrary.DislocatePulse),
                new WavePreviewEntry(_owner.T("Dismember event", "断肢瞬间"), DGLabWaveLibrary.DismemberPulse),
                new WavePreviewEntry(_owner.T("Self-harm event", "自伤刺痛"), DGLabWaveLibrary.SelfHarmPulse),
                new WavePreviewEntry(_owner.T("Electric shock", "电击"), DGLabWaveLibrary.Sting),
                new WavePreviewEntry(_owner.T("Treatment sting", "治疗刺痛"), DGLabWaveLibrary.TreatmentSting),

                new WavePreviewEntry(_owner.T("Mild pain", "轻微疼痛"), DGLabWaveLibrary.PainThrob),
                new WavePreviewEntry(_owner.T("Pain", "疼痛"), DGLabWaveLibrary.PainTremor),
                new WavePreviewEntry(_owner.T("Severe pain", "剧烈疼痛"), DGLabWaveLibrary.SeverePainTremor),
                new WavePreviewEntry(_owner.T("Agonizing pain", "剧痛难忍"), DGLabWaveLibrary.AgonySurge),
                new WavePreviewEntry(_owner.T("Shock", "休克"), DGLabWaveLibrary.HeavyShock),

                new WavePreviewEntry(_owner.T("Fracture", "骨折"), DGLabWaveLibrary.FractureThrob),
                new WavePreviewEntry(_owner.T("Dislocation", "关节脱位"), DGLabWaveLibrary.JointPulse),
                new WavePreviewEntry(_owner.T("Tissue injury", "组织损伤"), DGLabWaveLibrary.InjuryAche),
                new WavePreviewEntry(_owner.T("Nerve disruption", "神经异常"), DGLabWaveLibrary.ShockSpike),

                new WavePreviewEntry(_owner.T("Minor bleeding", "轻微出血"), DGLabWaveLibrary.MinorBleedDrain),
                new WavePreviewEntry(_owner.T("Moderate bleeding", "中度出血"), DGLabWaveLibrary.ModerateBleedDrain),
                new WavePreviewEntry(_owner.T("Severe bleeding", "严重出血"), DGLabWaveLibrary.HeavyBleedDrain),
                new WavePreviewEntry(_owner.T("Catastrophic bleeding", "灾难性出血"), DGLabWaveLibrary.CatastrophicBleedDrain),
                new WavePreviewEntry(_owner.T("Blood loss", "失血"), DGLabWaveLibrary.BloodLossFade),
                new WavePreviewEntry(_owner.T("Internal bleeding", "内出血"), DGLabWaveLibrary.ModerateBleedDrain),
                new WavePreviewEntry(_owner.T("Hemothorax", "血胸"), DGLabWaveLibrary.HemothoraxPressure),

                new WavePreviewEntry(_owner.T("Mild hypotension", "轻度低血压"), DGLabWaveLibrary.HypotensionFade),
                new WavePreviewEntry(_owner.T("Moderate hypotension", "中度低血压"), DGLabWaveLibrary.ModerateHypotensionFade),
                new WavePreviewEntry(_owner.T("Severe hypotension", "严重低血压"), DGLabWaveLibrary.SevereHypotensionFade),
                new WavePreviewEntry(_owner.T("Fatal hypotension", "致命低血压"), DGLabWaveLibrary.FatalHypotensionFade),
                new WavePreviewEntry(_owner.T("Mild hypertension", "轻度高血压"), DGLabWaveLibrary.HypertensionPressure),
                new WavePreviewEntry(_owner.T("Moderate hypertension", "中度高血压"), DGLabWaveLibrary.ModerateHypertensionPressure),
                new WavePreviewEntry(_owner.T("Severe hypertension", "严重高血压"), DGLabWaveLibrary.SevereHypertensionPressure),
                new WavePreviewEntry(_owner.T("Fatal hypertension", "致命高血压"), DGLabWaveLibrary.FatalHypertensionPressure),

                new WavePreviewEntry(_owner.T("Mild hypoxia", "轻度低氧血症"), DGLabWaveLibrary.MildHypoxiaFlutter),
                new WavePreviewEntry(_owner.T("Moderate hypoxia", "中度低氧血症"), DGLabWaveLibrary.ModerateHypoxiaStutter),
                new WavePreviewEntry(_owner.T("Severe hypoxia", "严重低氧血症"), DGLabWaveLibrary.OxygenStutter),
                new WavePreviewEntry(_owner.T("Fatal hypoxia", "致命低氧血症"), DGLabWaveLibrary.FatalHypoxiaGasp),
                new WavePreviewEntry(_owner.T("Suffocation", "窒息"), DGLabWaveLibrary.SuffocationGasp),
                new WavePreviewEntry(_owner.T("Palpitations", "心悸"), DGLabWaveLibrary.Heartbeat),
                new WavePreviewEntry(_owner.T("Tachyarrhythmia", "快速心律失常"), DGLabWaveLibrary.TachyHeartbeat),
                new WavePreviewEntry(_owner.T("Ventricular fibrillation", "室颤"), DGLabWaveLibrary.FibrillationChaos),
                new WavePreviewEntry(_owner.T("Cardiac arrest", "心跳骤停"), DGLabWaveLibrary.CardiacArrestDrop),

                new WavePreviewEntry(_owner.T("Mild infection", "轻度感染"), DGLabWaveLibrary.MildInfectionCrawl),
                new WavePreviewEntry(_owner.T("Painful infection", "疼痛性感染"), DGLabWaveLibrary.PainfulInfectionCrawl),
                new WavePreviewEntry(_owner.T("Severe infection", "严重感染"), DGLabWaveLibrary.SevereInfectionCrawl),
                new WavePreviewEntry(_owner.T("Sepsis", "败血症"), DGLabWaveLibrary.SepsisPulse),
                new WavePreviewEntry(_owner.T("Septic shock", "感染性休克"), DGLabWaveLibrary.SepticShockWave),
                new WavePreviewEntry(_owner.T("Nausea / stomach sickness", "恶心 / 胃部不适"), DGLabWaveLibrary.SicknessRoll),
                new WavePreviewEntry(_owner.T("Gravely ill", "病入膏肓"), DGLabWaveLibrary.GravelyIllWave),
                new WavePreviewEntry(_owner.T("Radiation sickness", "辐射病"), DGLabWaveLibrary.RadiationSicknessRoll),
                new WavePreviewEntry(_owner.T("Fatal radiation sickness", "致命辐射病"), DGLabWaveLibrary.AgonySurge),

                new WavePreviewEntry(_owner.T("Hunger cramps", "饥饿绞痛"), DGLabWaveLibrary.HungerGnaw),
                new WavePreviewEntry(_owner.T("Heat discomfort", "炎热不适"), DGLabWaveLibrary.HeatWave),
                new WavePreviewEntry(_owner.T("Dangerous heat", "危险高温"), DGLabWaveLibrary.SevereHeatWave),
                new WavePreviewEntry(_owner.T("Cold discomfort", "寒冷不适"), DGLabWaveLibrary.ColdShiver),
                new WavePreviewEntry(_owner.T("Hypothermia", "低体温"), DGLabWaveLibrary.SevereColdShiver),
                new WavePreviewEntry(_owner.T("Exertion", "体力透支"), DGLabWaveLibrary.FatiguePulse),
                new WavePreviewEntry(_owner.T("Severe exertion", "严重体力透支"), DGLabWaveLibrary.SevereFatigueDrag),
                ...
                new WavePreviewEntry(_owner.T("Panic", "惊恐"), DGLabWaveLibrary.PanicHeartbeat),
                new WavePreviewEntry(_owner.T("Trauma", "创伤"), DGLabWaveLibrary.TraumaFlashback),
